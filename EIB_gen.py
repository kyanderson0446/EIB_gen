...
for facility in facilities:
    print(fr"Creating file for {quarter_entry} {facility}")
    ...
    EIB_wb.save(
        fr"C:\Users\kyle.anderson\OneDrive - PACS\backup\Documents\Courtney\{quarter_entry} {facility} EIB_budget.xlsx")  # change quarter
# EIB_wb.close()
# app.quit()
current_year += 1
year_entry += 1
